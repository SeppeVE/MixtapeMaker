...
const props = defineProps<{ content: JCardContent; sanitizedContent: string }>();
...
const panelBgImage = computed(() => props.content.insideBackPanelImageUrl || props.content.insideBackgroundImageUrl);
