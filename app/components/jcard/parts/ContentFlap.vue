...
const bg = computed<CSSProperties>(() => ({
  backgroundColor: props.content.continuousBackground
    ? 'transparent'
    : props.content.backgroundImageUrl
      ? 'transparent'
      : props.content.backgroundColor,
  backgroundImage:
    !props.content.continuousBackground && props.content.backgroundImageUrl
...
const isEmpty = computed(
  () => !props.sanitizedContent || props.sanitizedContent === '<p><br></p>' || props.sanitizedContent.trim() === ''
);
</script>
