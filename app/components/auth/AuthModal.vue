...
async function handleGoogleSignIn() {
  ...
  try {
    ...
    // On success the browser redirects, so no need to close.
  } catch {
    error.value = 'An unexpected error occurred';
    loading.value = false;
  }
...
<template>
  <div v-if="ui.isAuthModalOpen" class="modal-overlay" @click="close">
    <div class="modal-content" @click.stop>
      ...
      <button type="button" class="google-button" :disabled="loading" @click="handleGoogleSignIn">
      ...
      <div class="auth-toggle">
        ...
        <template v-else>
          Don't have an account? <button @click="isSignUp = true">Sign Up</button>
        </template>
      </div>
    </div>
  </div>
