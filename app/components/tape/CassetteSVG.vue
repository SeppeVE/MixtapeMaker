...
const props = withDefaults(
  ...
  { title: undefined, side: 'A', accentColor: '#B4A0C7', float: true }
);
...
<template>
  <div :class="`${float ? 'lp-cassette-float' : 'cassette-svg'} line-height-0`">
    <svg
      ...
      class="cassette-drop-shadow block"
    >
      <!-- Shell -->
      ...
      <!-- Side letter -->
      <text x="41" y="47" font-family="monospace" font-size="20" font-weight="900" fill="#5B2838">
        {{ side }}
      </text>
      ...
      <template v-else>
        ...
        <text
          x="66" y="43" font-family="monospace" font-size="9"
          font-weight="700" fill="#2A1E28"
      ...
      <g v-for="([cx, cy], i) in screws" :key="i">
